    ...
    <form action={formAction} className={FORM_STACK}>
      ...
      <div className="grid gap-5 mobile:gap-4 grid-cols-2 mobile:grid-cols-1">
        <div className="flex flex-col gap-1.5">
          <label htmlFor="company" className={LABEL}>Company <span className="[color:var(--st-rejected)]">*</span></label>
          <input
            id="company"
            type="text"
            name="company"
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="role" className={LABEL}>Role <span className="[color:var(--st-rejected)]">*</span></label>
          <input
            id="role"
            type="text"
            name="role"
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="location" className={LABEL}>Location <span className="[color:var(--st-rejected)]">*</span></label>
          <input
            id="location"
            type="text"
            name="location"
