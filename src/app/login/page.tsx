    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 px-4 mobile:items-start mobile:pt-12">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl shadow-lg shadow-indigo-200 dark:shadow-indigo-900 mobile:h-14 mobile:w-14">
            <Image src="/icon-192.png" alt="AppTrack" width={56} height={56} className="rounded-2xl" priority />
          </div>
